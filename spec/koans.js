...
describe('the JavaScript language', () => {
  ...
  describe('considers functions as first class citizens', () => {
    ...
    it('may return arrays that contains functions and so on', () => {
      function example() {
        return [function parrandas(arg){return [0,arg * 10]}]
      }
    ...
    it('may return arrays that contains closures and so on', () => {
      function example() {
        return [function parrandas2(arg){return [0,arg + 9]}]
      }
      ...
      function createObject(initialScore, color) {
        let points = 0
                return {
                    color: color,
                    score: points,
                    points: function() { return initialScore * 2 },
                    incrementScoreIn: function(increment) { return increment += points }
      }
    } 
